 ...
 * every scheduled attempt of the day (07:45, 08:45, 09:45 Europe/Berlin) has
 * failed and no briefing went out, so the failure is visible somewhere other
 * than the Actions log. Uses the same Gmail SMTP setup as send-email.ts.
 */
...
async function main() {
  ...
  await transporter.sendMail({
    ...
    text: [
      `Das Daily News Briefing konnte heute (${today}) nach mehreren Versuchen ` +
        '(07:45, 08:45, 09:45 Uhr Europe/Berlin) nicht erzeugt oder versendet werden.',
